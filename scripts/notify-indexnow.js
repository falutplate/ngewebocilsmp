...
// --- Konfigurasi Anda ---
const YOUR_DOMAIN = 'https://ngewebocilsmp.pages.dev'; // Ganti dengan domain Anda yang sebenarnya
const API_KEY_NAME = 'db018659-d5d3-4b1f-8354-18b235472367'; // Ganti dengan GUID Anda
